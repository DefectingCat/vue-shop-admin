...
// children
import PickCate from '@/components/Params/PickCate.vue';
import ParamsTable from '@/components/Params/ParamsTable.vue';
import ParamsForm from '@/components/Params/ParamsForm.vue';
// logical
